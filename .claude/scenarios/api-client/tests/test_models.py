...
class TestRetryPolicy:
    ...
    def test_retry_policy_with_jitter(self) -> None:
        ...
        # With jitter, backoffs should be slightly different
        # (though they might randomly be equal)
        assert backoff1 >= 0.5  # At least 50% of base
        assert backoff1 <= 1.5  # At most 150% of base
...
class TestDataclassImmutability:
    ...
    def test_all_models_are_frozen(self) -> None:
        ...
        from amplihack.api_client.models import ClientConfig, Request, Response, RetryPolicy
        ...
        # Note: ClientConfig and RetryPolicy might not be frozen
        # depending on design - adjust tests based on actual implementation
