...
For comprehensive auto mode documentation, see docs/AUTO_MODE.md""",
    ...
    codex_parser.add_argument("--auto", action="store_true", help="Run in autonomous agentic mode. Usage: --auto -- -p 'your task'. See docs/AUTO_MODE.md for details.")
    codex_parser.add_argument("--max-turns", type=int, default=10, help="Max turns for auto mode (default: 10). Guidance: 5-10 for simple tasks, 10-15 for medium complexity, 15-30 for complex tasks.")
